...
public class PostionDataHandler : MonoBehaviour
{
    [Range(0f, 2f)]
    ...
    void Start()
    {
        ...
        previousPostion = new Vector2(wallE.transform.position.x * positionScale, wallE.transform.position.z * positionScale);
    ...
    {
        Vector2 postion = new Vector2(wallE.transform.position.x * positionScale, wallE.transform.position.z * positionScale);
